...
def render_test(args):
    ...
    if args.render_train:
        ...
        train_dataset = dataset(args.datadir, split='train', downsample=args.ray_downsample_train, is_stack=True)
...
def reconstruction(args):
    ...
    # init dataset
    dataset = dataset_dict[args.dataset_name]
    train_dataset = dataset(args.datadir, split='train', downsample=args.ray_downsample_train, is_stack=False)
    test_dataset = dataset(args.datadir, split='test', downsample=args.ray_downsample_train, is_stack=True)
